...
class CommonStrategyTest {
    ...
    @Test
    @DisplayName("parse should extract Model and LoRAs with escaped Unicode sequences in Civitai resources")
    void testEscapedUnicodeCivitaiResources() {
        String metadata = "inksketch, a digital painting\nNegative prompt: \nSteps: 25, Sampler: Undefined, CFG scale: 3.5, Seed: 445954347, Size: 1024x1024, Clip skip: 2, Civitai resources: [{\"type\":\"checkpoint\",\"modelVersionId\":691639,\"modelName\":\"FLUX\",\"modelVersionName\":\"Dev\"},{\"type\":\"lora\",\"weight\":0.55,\"modelVersionId\":978472,\"modelName\":\"OB\\u534A\\u5199\\u5B9E\\u8096\\u50CF\\u753B Semi-realistic portrait painting\",\"modelVersionName\":\"v2.0\"},{\"type\":\"lora\",\"weight\":0.7,\"modelVersionId\":1075265,\"modelName\":\"Sommo Sci-Fi Concept Art by ChronoKnight - [FLUX & IL]\",\"modelVersionName\":\"FLUX v1.0\"}], Civitai metadata: {}";
